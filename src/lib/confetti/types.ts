export type ConfettiProps = Partial<{
  /**
  ...
  size: number;
  /**
   * The max horizontal range of the confetti pieces.
   * Negative is left, positive is right. [-1, 1] would mean maximum of 200px left and 200px right.
   * @default [-0.5, 0.5]
   */
  x: number[];
  /**
