const o = [
  ...
  "/chi-fan/_app/immutable/assets/_page-8b342e37.css",
  ...
  "/chi-fan/_app/immutable/chunks/4-241b4df0.js",
  ...
  "/chi-fan/_app/immutable/chunks/6-526a41bb.js",
  ...
  "/chi-fan/_app/immutable/components/pages/doors/_page.svelte-dc12c223.js",
  "/chi-fan/_app/immutable/start-013efdc9.js",
  ...
  "/chi-fan/_app/immutable/components/pages/sugar-cane-water/intro/_page.svelte-4155f798.js"
], h = [
  "/chi-fan/.nojekyll",
  "/chi-fan/favicon.png",
...
], r = "1677993130570", i = self, g = `cache${r}`, s = o.concat(
...
i.addEventListener("fetch", (a) => {
  if (a.request.method !== "GET" || a.request.headers.has("range"))
    return;
  const n = new URL(a.request.url), c = n.protocol.startsWith("http"), e = n.hostname === self.location.hostname && n.port !== self.location.port, t = n.host === self.location.host && m.has(n.pathname), p = a.request.cache === "only-if-cached" && !t;
  c && !e && !p && a.respondWith(
